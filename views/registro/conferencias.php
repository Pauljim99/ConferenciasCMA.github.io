...
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        <h3 class="eventos-registro__heading--conferencias">Conferencias CMA</h3>
        <p class="eventos-registro__fecha">Viernes 20 de Junio</p>
        ...
        <p class="eventos-registro__fecha">Sabado 21 de Junio</p>
        <div class="eventos-registro__grid">
            <?php foreach ($eventos['conferencias_v'] as $evento) { ?>
                <?php include __DIR__ . '/evento.php'; ?>
            <?php } ?>
        ...
        <h3 class="eventos-registro__heading--workshops">Workshops(Taller) CMA</h3>
        <p class="eventos-registro__fecha">Viernes 20 de Junio</p>
