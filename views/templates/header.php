<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">20-21 JUNIO 2024</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            <a href="/conferenciasCMA" class="navegacion__enlace <?php echo pagina_actual('/conferenciasCMA') ? 'navegacion__enlace--actual' : '' ; ?>">Evento</a>
    ...
    /* Elimina el color de fondo y el borde para permitir el degradado */
    ...
    /* Aplica el degradado */
    background-image: linear-gradient(to right,#00D3DA   ,#0098F2  );
}
      .bd-mode-toggle {
        z-index: 1500;
      }
      ...
      padding: 0.75rem 1.5rem; /* Ajusta el padding para un tamaño mayor */
      }
