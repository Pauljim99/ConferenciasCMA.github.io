...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de Conferencias CMA</p>
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker__sociales">
                        ...
                        <?php if (!empty($redes->twitter)) { ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->twitter; ?>m">
